...
options:
        ...
        suboptions:
            primary_nic:
                ...
                suboptions:
                    ...
                    vlan:
                        description:
                            - The name of an existing VLAN to attach this NIC to
                            - Required if a primary_nic is supplied
                        required: false
                        type: str
                    privateIpv4:
                        description:
                            - The specific IPv4 address to assign to this NIC
                        required: false
                        type: str
            additional_nic:
                description:
                ...
                suboptions:
                    networkAdapter:
                        description:
                            - The NIC adapter type
                            - Required if an additional_nic is supplied
                        required: false
                        type: str
                        choices:
                            - E1000
                    ...
                    vlan:
                        description:
                            - The name of an existing VLAN to attach this NIC to
                            - Required if a additional_nic is supplied
                        required: false
                        type: str
                    privateIpv4:
                        description:
    ...
    server_state:
        description:
            ...
            - Not generally required for normal module use
        required: false
        type: str
        default: NORMAL
        choices:
    ...
    new_name:
        description:
            - The new name to use when renaming a server
        required: false
        type: str
    state:
        description:
...
def create_server(module, client):
    ...
    try:
        ...
        module.fail_json(msg='Could not create the server - {0}'.format(e), exception=traceback.format_exc())
